...
<HEAD>
	...
	<script>
		function modifypsw() {
			var dw = window
					.showModalDialog(
							'${pageContext.request.contextPath}/uiAction_staff_updPwd',
							'',
		...
		<tr>
			<td>
				<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2">
					<tr>
						<td width="420"><img border="0"
							src="${pageContext.request.contextPath}/images/topbg.jpg"
							width="436" height="80">
						</td>
						...
						<td width="374"
							background="${pageContext.request.contextPath}/images/topright.jpg"
							valign="top">
											...
											<table border="0" width="215" cellspacing="0" cellpadding="0"
												...
												<tr>
													...
													<%--
														...
														<a href="javascript:void(0)" onclick="javascript:modifypsw();">
															<font color="ffffff">更改口令</font>
														</a>
													--%>
														<a
															href="${pageContext.request.contextPath}/pages/staff/updPwd.jsp"
															target="right"> <font color="ffffff">更改口令</font>
														</a>
													</td>
