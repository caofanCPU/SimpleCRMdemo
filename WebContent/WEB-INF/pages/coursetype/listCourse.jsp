...
<body>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="wukuang" width="100%">
		<tr>
			<td width="1%"><img
				src="${pageContext.request.contextPath}/images/tleft.gif" />
			</td>
			...
			<td width="57%" align="right">
				...
				<%--
						编辑前：添加操作
						1.此处s:a标签，点击"编辑"图标将触发courseTypeAction_addOrEditUI
						2.正因为是"编辑"，所以需要传递"courseTypeId"，交予服务端判定处理
				--%>
	...
	<table border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td>
				<img rc="${pageContext.request.contextPath}/images/result.gif" />
			</td>
		</tr>
	</table>
	...
	<table width="97%" border="1">
		...
		<s:iterator value="#pageBean.data" var="coursetype">
			<tr class="tabtd1">
				...
				<td align="center">
					<s:property value="#coursetype.remark" />
				</td>
				<td align="center">
					<s:property value="#coursetype.total" />
				</td>
				<td align="center">
					<s:property value="#coursetype.courseCost" />
				</td>
